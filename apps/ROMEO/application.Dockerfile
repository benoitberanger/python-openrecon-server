...
# Get romeo.jl file from ROMEO github repository
RUN mkdir -p /opt/romeo && \
    curl -fsSL https://raw.githubusercontent.com/korbinian90/ROMEO.jl/master/romeo.jl -o /opt/romeo/romeo.jl
